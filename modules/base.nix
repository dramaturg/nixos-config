  ...
  users = {
    ...
    extraUsers = {
      seb = {
        ...
        description = "Seb";
        isNormalUser = true;
        extraGroups = ["wheel" "docker" "libvirtd" "audio" "networkmanager" "dialup"];
        uid = 1000;
        openssh.authorizedKeys.keys = [
          ...
          "ssh-rsa "
        ];
      };
      root = {
        openssh.authorizedKeys.keys = [
